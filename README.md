...
| <a name="input_database_version"></a> [database\_version](#input\_database\_version) | The database version to use. Check https://cloud.google.com/sql/docs/db-versions for supported versions. | `string` | n/a | yes |
